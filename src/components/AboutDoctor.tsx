      ...
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-12 items-center max-w-5xl mx-auto">
          ...
          <div className="order-2 md:order-1">
            <h3 className="text-2xl sm:text-3xl font-bold text-accent mb-4 md:mb-6">
              Dr. Santiago Vecina
            </h3>
          ...
          <div className="order-1 md:order-2">
            <div className="rounded-2xl border-2 border-accent/30 overflow-hidden max-w-xs sm:max-w-sm md:max-w-full mx-auto">
              <img
                src={drSantiago}
